...
from core.providers.voice_provider import VoiceProvider, TTS_PROVIDER_TYPES  # noqa: E402
from core.providers.tts.groq import GroqTTSProvider  # noqa: E402
...
def test_groq_config_loaded():
    ...
    print("[PASS] Groq TTS config loaded:")
