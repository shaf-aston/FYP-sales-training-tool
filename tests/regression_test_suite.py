...
Usage:
    ...
    python tests/regression_test_suite.py --fast
    python tests/regression_test_suite.py --voice
    python tests/regression_test_suite.py --report
"""
...
class RegressionTestRunner:
    ...
    def generate_report(self, all_results: List[Dict]) -> str:
        ...
        report.append("=" * 80)
        report.append(f"Timestamp: {datetime.now(UTC).strftime('%Y-%m-%d %H:%M:%S')}")
