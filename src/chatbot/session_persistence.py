...
# Absolute path: src/chatbot/../.. = repo root, then /sessions
...
class SessionPersistence:
    """Minimal atomic writer for session state."""
    ...
    def save(session_id: str, product_type: Optional[str], provider_type: Optional[str],
             ...
             conversation_history: list[dict[str, str]], initial_flow_type: str) -> bool:
