...
def voice_synthesize():
    ...
    try:
        ...
        return jsonify({"error": "Speech generation hit a snag -- give it another shot"}), 500
...
def voice_chat():
    ...
    try:
        ...
        transcription = voice_provider.transcribe(audio_bytes, filename=audio_file.filename or "audio.webm")
        ...
        return jsonify({"error": "Voice mode ran into trouble -- try that again"}), 500
